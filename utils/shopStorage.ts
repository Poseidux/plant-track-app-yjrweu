  ...
  async unlockAllItems(): Promise<void> {
    try {
      ...
      const allItemIds = [
        ...
        'theme-tropical-paradise-dark',
        'theme-desert-sand',
        'theme-desert-sand-dark',
        'theme-lavender-fields',
        'theme-lavender-fields-dark',
        'theme-mint-fresh',
        'theme-mint-fresh-dark',
        'theme-coral-reef',
        'theme-coral-reef-dark',
        'theme-slate-gray',
        'theme-slate-gray-dark',
        'theme-golden-hour',
        'theme-golden-hour-dark',
        'theme-rose-garden',
        'theme-rose-garden-dark',
        'theme-emerald-forest',
        'theme-emerald-forest-dark',
        'theme-sapphire-sky',
        'theme-sapphire-sky-dark',
